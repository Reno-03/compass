            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 px-5 py-4">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-emerald-700 cursor-pointer sm:text-sm"
                >
